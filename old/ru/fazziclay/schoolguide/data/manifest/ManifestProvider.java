...
public class ManifestProvider extends BaseProvider {
    private static final String MANIFEST_LOCAL_FILE = "schoolguide.global_manifest.json";
    ...
    public BaseData load() {
        Gson gson = new Gson();
        return gson.fromJson(FileUtil.read(filePath, SharedConstrains.JSON_EMPTY_OBJECT), Manifest.class);
    }
