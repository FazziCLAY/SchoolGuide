...
public class SharedConstrains {
    ...
    public static final int DEV_FEATURED_MANIFEST_GLOBAL_DELAY = 0;
    ...
    public static final String CRASHREPORT_NOTIFICATION_CHANNEL_ID = "CrashReport";
    public static final short CRASHREPORT_NOTIFICATION_ID = 555;
    ...
    public static final int INTERNET_TERMINATOR_DELAY = 60 * 60;
}
